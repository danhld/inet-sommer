...
#ifndef NETWORKLAYER_DYMO_DYMO_ROUTINGENTRY_H
#define NETWORKLAYER_DYMO_DYMO_ROUTINGENTRY_H
...
#include "networklayer/dymo/DYMO_Timer.h"
...
{
	public:
		DYMO_RoutingEntry(DYMOnet__DYMO* dymo);
	...
	protected:
		DYMOnet__DYMO* dymo; /**< DYMO module */

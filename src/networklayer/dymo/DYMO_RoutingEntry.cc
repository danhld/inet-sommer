...
#include "networklayer/dymo/DYMO_RoutingEntry.h"
#include "networklayer/dymo/DYMO.h"

namespace DYMOnet {

DYMO_RoutingEntry::DYMO_RoutingEntry(DYMOnet__DYMO* dymo) : routeAgeMin(dymo, "routeAgeMin"), routeAgeMax(dymo, "routeAgeMax"), routeNew(dymo, "routeNew"), routeUsed(dymo, "routeUsed"), routeDelete(dymo, "routeDelete"), routingEntry(0), dymo(dymo) {
